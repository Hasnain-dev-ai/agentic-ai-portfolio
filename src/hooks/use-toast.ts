...
// Removed duplicate 'toast' function
  // This is a simplified toast implementation
  // In a real application, you would use a proper toast library or context
export function showToast({ title, description, variant = "default", duration = 3000 }: ToastParams) {

  // Create a DOM element for the toast (simplified)
